...
# Form implementation generated from reading ui file 'losts_detail_menu.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "분실물 상세 정보", None))
        ...
        item.setText(_translate("Form", "분실 시간", None))
        item = self.tableWidget.verticalHeaderItem(3)
        item.setText(_translate("Form", "분실 지역", None))
        item = self.tableWidget.verticalHeaderItem(4)
        item.setText(_translate("Form", "분실 장소", None))
        item = self.tableWidget.verticalHeaderItem(5)
        item.setText(_translate("Form", "기관 ID", None))
        item = self.tableWidget.verticalHeaderItem(6)
        item.setText(_translate("Form", "접수 기관", None))
        item = self.tableWidget.verticalHeaderItem(7)
        item.setText(_translate("Form", "분실물 상태", None))
