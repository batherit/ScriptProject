...
class MyLostsDetailMenuForm(QtGui.QMainWindow):
    ...
    def print_image(self):
        global chrome_path
        tree = ElementTree.fromstring(str(self.detailOfLostsXMLDoc.toxml()))
        webbrowser.get(chrome_path).open(tree.find('body').find('item').find("lstFilePathImg").text)
        return
...
class MyFoundsKindSearchForm(QtGui.QMainWindow):
    ...
    def founds_kind_search(self):
        ...
        goods_kind_dic =  \
        { 
            0 : "PRA000", 1 : "PRB000", 2 : "PRC000", 3 : "PRD000", 4 : "PRE000", 
            5 : "PRF000", 6 : "PRG000", 7 : "PRH000", 8 : "PRI000", 9 : "PRJ000",
